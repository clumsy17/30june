  ...
  swal({
    ...
    if (value) {
      ...
      swal("Masukkan pesan yang ingin kamu kirim:", {
        ...
        if (value) {
          const whatsappUrl = `https://api.whatsapp.com/send?phone=081917028074&text=${encodeURIComponent(
            value
          )}%0A+I+Love+You`;
