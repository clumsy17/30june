const validCredentials = {
  username: "celle", // MASUKAN USERNAME KAMU DISINI, CONTOH: 'admin'
  password: "30june", // MASUKAN PASSWORD KAMU DISINI, CONTOH: 'admin'
};
...
function checkLogin() {
  ...
  if (
    ...
    document.getElementById("error-message").textContent =
      "Username atau password salah, coba lagi ya :p ❤️";
  }
}
